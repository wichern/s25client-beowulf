...
BOOST_FIXTURE_TEST_CASE(PlanBuilding, BiggerWorldWithGCExecution)
{
    ...
    beowulf::Island island = beowulf.buildings.GetIsland(MapPoint(13, 12));
    beowulf::BuildingsPlan plan(beowulf.buildings, island);
...
BOOST_FIXTURE_TEST_CASE(PlanRoadSouthEast, BiggerWorldWithGCExecution)
{
    ...
    plan.PlanRoad(MapPoint(13,12), {Direction::SOUTHEAST, Direction::SOUTHEAST, Direction::SOUTHEAST, Direction::SOUTHEAST});
...
BOOST_FIXTURE_TEST_CASE(IsRoadPossible, BiggerWorldWithGCExecution)
{
    ...
    BOOST_REQUIRE(!plan.IsRoadPossible(world, MapPoint(13, 12), Direction::NORTHWEST));
    BOOST_REQUIRE(plan.IsRoadPossible(world, MapPoint(13, 12), Direction::WEST));
    BOOST_REQUIRE(plan.IsRoadPossible(world, MapPoint(15, 15), Direction::WEST));
    BOOST_REQUIRE(!plan.IsRoadPossible(world, MapPoint(11, 11), Direction::EAST));
    BOOST_REQUIRE(!plan.IsRoadPossible(world, MapPoint(21, 10), Direction::EAST));
    ...
    BOOST_REQUIRE(!plan.IsRoadPossible(world, MapPoint(9, 13), Direction::NORTHWEST));
